...
{
    public class EmployeeLoginMessage
    {
        ...
        private static EmployeeLoginMessage _instance;

        /// <summary>
        /// Gets the single instance of the Messenger.
        /// </summary>
        public static EmployeeLoginMessage Default
        {
            get
            {
                if (_instance == null)
                {
                    lock (CreationLock)
                    {
                        if (_instance == null)
                        {
                            _instance = new EmployeeLoginMessage();
                        }
                    }
                }
